...
The data is in a [zip](https://drive.google.com/file/d/1qhabjrG8qCmRCebUBeAVDHZa3aQVKigw/view?usp=sharing) file. The zip file contains a 'train' and a 'val' folder with two CSV files for the two folders.
